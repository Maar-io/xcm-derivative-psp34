...
pub mod derivative {
	...
	impl PSP34 for XcmDerivative {}
	impl Ownable for XcmDerivative {}
	impl PSP34Burnable for XcmDerivative {
		#[ink(message)]
	...
	impl PSP34Mintable for XcmDerivative {
		#[ink(message)]
		#[openbrush::modifiers(only_owner)]
		fn mint(
            &mut self,
	...
	impl PSP34Enumerable for XcmDerivative {}
	impl PSP34Metadata for XcmDerivative {}
